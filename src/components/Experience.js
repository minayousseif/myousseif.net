                        ...
                        <ul className="timeline">
                            <li>
                                ...
                                <div className="timeline-panel timeline-head-panel">
                                    <div className="timeline-heading">
                                        ...
                                        <h4 className="subheading">Malwarebytes - Clearwater FL</h4>
                                        <h4 className="subheading">Sept 2016-Current</h4>
                                    </div>
                                </div>
                            ...
                            <li>
                                ...
                                <div className="timeline-panel timeline-head-panel">
                                    <div className="timeline-heading">
                                        <h4>Web Developer</h4>
                                        <h4 className="subheading">Daniels Corporation - Tampa FL</h4>
                                        <h4 className="subheading">Nov 2013-Aug 2016</h4>
                                    </div>
                                </div>
                                <div className="timeline-panel timeline-body-panel">
                                    <div className="timeline-body">
                            ...
                            <li>
                                ...
                                <div className="timeline-panel timeline-head-panel">
                                    <div className="timeline-heading">
                                        ...
                                        <h4 className="subheading">Mensch Supply - NY</h4>
                                        <h4 className="subheading">Nov 2010 - Aug 2012</h4>
                                    </div>
                                </div>
                                <div className="timeline-panel timeline-body-panel">
                                    <div className="timeline-body">
